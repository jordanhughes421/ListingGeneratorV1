...
export async function POST(req: NextRequest) {
    try {
        ...
        const keywordPromiseEtsy = generateContent(`Generate optimized search terms for an Amazon listing titled ${titlesEtsy}. Please provide a list of keywords totaling up to 250 characters (Amazon's limit for search terms). Do not duplicate keywords, use cognates, commas, or punctuation. Your goal is to specify as many searches as possible so that the customers can easily find your products. These terms should target the search words: ${keywords}, ensuring they are highly relevant to the product and likely to be used by potential buyers in their searches.`);
